...
func (x *EntityBasic) GetWorkspaceId() string {
	if x != nil {
...
func (x *RetrieveIDByRouteReq) GetWorkspaceId() string {
	if x != nil {
		return x.WorkspaceId
	}
	return ""
...
const file_common_v1_common_proto_rawDesc = "" +
	...
	"\x06entity\x18\x01 \x01(\v2\x16.common.v1.EntityBasicR\x06entity\"\x80\x01\n" +
	...
	"\x04type\x18\x04 \x01(\rR\x04type\"O\n" +
	"\x14RetrieveIDByRouteReq\x12\x14\n" +
	"\x05route\x18\x01 \x01(\tR\x05route\x12!\n" +
	"\fworkspace_id\x18\x02 \x01(\tR\vworkspaceIdB2Z0github.com/absmach/magistrala/api/grpc/common/v1b\x06proto3"
