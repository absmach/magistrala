...
func (_mock *Service) ViewAlarm(ctx context.Context, session authn.Session, id string, withRoles bool) (alarms.Alarm, error) {
	...
	var r0 alarms.Alarm
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, authn.Session, string, bool) (alarms.Alarm, error)); ok {
		return returnFunc(ctx, session, id, withRoles)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, authn.Session, string, bool) alarms.Alarm); ok {
...
//   - id string
//   - withRoles bool
func (_e *Service_Expecter) ViewAlarm(ctx interface{}, session interface{}, id interface{}, withRoles interface{}) *Service_ViewAlarm_Call {
	return &Service_ViewAlarm_Call{Call: _e.mock.On("ViewAlarm", ctx, session, id, withRoles)}
}

func (_c *Service_ViewAlarm_Call) Run(run func(ctx context.Context, session authn.Session, id string, withRoles bool)) *Service_ViewAlarm_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *Service_ViewAlarm_Call) RunAndReturn(run func(ctx context.Context, session authn.Session, id string, withRoles bool) (alarms.Alarm, error)) *Service_ViewAlarm_Call {
	_c.Call.Return(run)
	return _c
}
