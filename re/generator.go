...
// 	headerBlue := color.Color{Red: 64, Green: 126, Blue: 201}
// 	footerBlue := color.Color{Red: 64, Green: 126, Blue: 201}
// 	alternateRow := color.Color{Red: 240, Green: 240, Blue: 240}
// 	white := color.NewWhite()
// 	tableHeaderBg := color.Color{Red: 220, Green: 220, Blue: 220}
// 	titleColor := color.Color{Red: 0, Green: 51, Blue: 102}
...
// 		m.SetBackgroundColor(headerBlue)
...
// 		m.SetBackgroundColor(footerBlue)
// 		m.Row(1, func() { m.Col(12, func() {}) })
// 		m.SetBackgroundColor(white)
...
// 		m.Row(8, func() {
// 			m.Col(12, func() {
// 				m.Text(fmt.Sprintf("Device ID: %s", report.Metric.ClientID), props.Text{
// 					Size:  12,
// 					Style: consts.Bold,
// 				})
// 			})
...
// 		m.Row(8, func() {
// 			m.Col(12, func() {
// 				m.Text(fmt.Sprintf("Channel ID: %s", report.Metric.ChannelID), props.Text{
// 					Size:  12,
// 					Style: consts.Bold,
// 				})
// 			})
