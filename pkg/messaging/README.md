...
`Subscriber` interface defines methods used to subscribe to a message broker such as MQTT or FluxMQ.

`Publisher` interface defines methods used to publish messages to a message broker such as MQTT or FluxMQ.
