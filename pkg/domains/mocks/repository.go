...
func (_m *DomainsRepository) AddRoles(ctx context.Context, rps []roles.RoleProvision) ([]roles.Role, error) {
...
func (_m *DomainsRepository) RemoveRoles(ctx context.Context, roleIDs []string) error {
...
func (_m *DomainsRepository) RetrieveAllRoles(ctx context.Context, entityID string, limit uint64, offset uint64) (roles.RolePage, error) {
...
func (_m *DomainsRepository) RetrieveRole(ctx context.Context, roleID string) (roles.Role, error) {
...
func (_m *DomainsRepository) RetrieveRoleByEntityIDAndName(ctx context.Context, entityID string, roleName string) (roles.Role, error) {
...
func (_m *DomainsRepository) RoleAddActions(ctx context.Context, role roles.Role, actions []string) ([]string, error) {
...
func (_m *DomainsRepository) RoleAddMembers(ctx context.Context, role roles.Role, members []string) ([]string, error) {
...
func (_m *DomainsRepository) RoleCheckActionsExists(ctx context.Context, roleID string, actions []string) (bool, error) {
...
func (_m *DomainsRepository) RoleCheckMembersExists(ctx context.Context, roleID string, members []string) (bool, error) {
...
func (_m *DomainsRepository) RoleListActions(ctx context.Context, roleID string) ([]string, error) {
	ret := _m.Called(ctx, roleID)
...
func (_m *DomainsRepository) RoleListMembers(ctx context.Context, roleID string, limit uint64, offset uint64) (roles.MembersPage, error) {
...
func (_m *DomainsRepository) RoleRemoveActions(ctx context.Context, role roles.Role, actions []string) error {
	ret := _m.Called(ctx, role, actions)
...
func (_m *DomainsRepository) RoleRemoveAllActions(ctx context.Context, role roles.Role) error {
...
func (_m *DomainsRepository) RoleRemoveAllMembers(ctx context.Context, role roles.Role) error {
	ret := _m.Called(ctx, role)
...
func (_m *DomainsRepository) RoleRemoveMembers(ctx context.Context, role roles.Role, members []string) error {
	ret := _m.Called(ctx, role, members)
...
func (_m *DomainsRepository) UpdateRole(ctx context.Context, ro roles.Role) (roles.Role, error) {
