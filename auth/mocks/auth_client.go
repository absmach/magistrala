...
func (_m *AuthClient) VerifyConnections(ctx context.Context, in *magistrala.VerifyConnectionsReq, opts ...grpc.CallOption) (*magistrala.VerifyConnectionsRes, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
// AuthClient_VerifyConnections_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'VerifyConnections'
type AuthClient_VerifyConnections_Call struct {
	*mock.Call
}
...
//   - opts ...grpc.CallOption
func (_e *AuthClient_Expecter) VerifyConnections(ctx interface{}, in interface{}, opts ...interface{}) *AuthClient_VerifyConnections_Call {
	return &AuthClient_VerifyConnections_Call{Call: _e.mock.On("VerifyConnections",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *AuthClient_VerifyConnections_Call) Run(run func(ctx context.Context, in *magistrala.VerifyConnectionsReq, opts ...grpc.CallOption)) *AuthClient_VerifyConnections_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *AuthClient_VerifyConnections_Call) Return(_a0 *magistrala.VerifyConnectionsRes, _a1 error) *AuthClient_VerifyConnections_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *AuthClient_VerifyConnections_Call) RunAndReturn(run func(context.Context, *magistrala.VerifyConnectionsReq, ...grpc.CallOption) (*magistrala.VerifyConnectionsRes, error)) *AuthClient_VerifyConnections_Call {
	_c.Call.Return(run)
	return _c
}
