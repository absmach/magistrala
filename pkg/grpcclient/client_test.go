...
import (
	...
	domainsMocks "github.com/absmach/magistrala/pkg/domains/mocks"
...
func TestSetupDomainsClient(t *testing.T) {
	...
	registerDomainsServiceServer := func(srv *grpc.Server) {
		magistrala.RegisterDomainsServiceServer(srv, domainsgrpcapi.NewDomainsServer(new(domainsMocks.Service)))
	}
