...
const (
	addRuleQuery = `
		INSERT INTO rules (id, name, domain_id, metadata, input_channel, input_topic, logic_type, logic_value,
			output_channel, output_topic, start_datetime, recurring_time, recurring_type, recurring_period, created_at, created_by, updated_at, updated_by, status)
	...
	updateRuleQuery = `
		...
		SET name = :name, metadata = :metadata, input_channel = :input_channel, input_topic = :input_topic, logic_type = :logic_type, 
			...
			start_datetime = :start_datetime, recurring_time = :recurring_time, recurring_type = :recurring_type, 
