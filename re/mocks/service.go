...
// ListRuleLogs provides a mock function for the type Service
func (_mock *Service) ListRuleLogs(ctx context.Context, session authn.Session, pm re.LogPageMeta) (re.LogPage, error) {
	ret := _mock.Called(ctx, session, pm)

	if len(ret) == 0 {
		panic("no return value specified for ListRuleLogs")
	}

	var r0 re.LogPage
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, authn.Session, re.LogPageMeta) (re.LogPage, error)); ok {
		return returnFunc(ctx, session, pm)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, authn.Session, re.LogPageMeta) re.LogPage); ok {
		r0 = returnFunc(ctx, session, pm)
	} else {
		r0 = ret.Get(0).(re.LogPage)
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, authn.Session, re.LogPageMeta) error); ok {
...
// Service_ListRuleLogs_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ListRuleLogs'
type Service_ListRuleLogs_Call struct {
	*mock.Call
}

// ListRuleLogs is a helper method to define mock.On call
//   - ctx context.Context
//   - session authn.Session
//   - pm re.LogPageMeta
func (_e *Service_Expecter) ListRuleLogs(ctx interface{}, session interface{}, pm interface{}) *Service_ListRuleLogs_Call {
	return &Service_ListRuleLogs_Call{Call: _e.mock.On("ListRuleLogs", ctx, session, pm)}
}

func (_c *Service_ListRuleLogs_Call) Run(run func(ctx context.Context, session authn.Session, pm re.LogPageMeta)) *Service_ListRuleLogs_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
		...
		var arg2 re.LogPageMeta
		if args[2] != nil {
			arg2 = args[2].(re.LogPageMeta)
		}
		run(
			arg0,
			arg1,
...
func (_c *Service_ListRuleLogs_Call) Return(logPage re.LogPage, err error) *Service_ListRuleLogs_Call {
	_c.Call.Return(logPage, err)
	return _c
}

func (_c *Service_ListRuleLogs_Call) RunAndReturn(run func(ctx context.Context, session authn.Session, pm re.LogPageMeta) (re.LogPage, error)) *Service_ListRuleLogs_Call {
	_c.Call.Return(run)
	return _c
}
