...
func main() {
	...
	svc, err := newService(database, msgSub, writersPub, alarmsPub, authz, ec, logger, readersClient)
	if err != nil {
...
func newService(db pgclient.Database, rePubSub messaging.PubSub, writersPub, alarmsPub messaging.Publisher, authz mgauthz.Authorization, ec email.Config, logger *slog.Logger, readersClient grpcReadersV1.ReadersServiceClient) (re.Service, error) {
