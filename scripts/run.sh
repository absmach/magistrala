...
# Devices
###
MG_DEVICES_LOG_LEVEL=info MG_DEVICES_HTTP_PORT=9000 MG_DEVICES_GRPC_PORT=7000 MG_DEVICES_AUTH_HTTP_PORT=9002 $BUILD_DIR/magistrala-devices &

###
# HTTP
###
MG_HTTP_ADAPTER_LOG_LEVEL=info MG_HTTP_ADAPTER_PORT=8008 MG_DEVICES_GRPC_URL=localhost:7000 $BUILD_DIR/magistrala-http &


###
# MQTT
###
MG_MQTT_ADAPTER_LOG_LEVEL=info MG_DEVICES_GRPC_URL=localhost:7000 $BUILD_DIR/magistrala-mqtt &

###
# CoAP
###
MG_COAP_ADAPTER_LOG_LEVEL=info MG_COAP_ADAPTER_PORT=5683 MG_DEVICES_GRPC_URL=localhost:7000 $BUILD_DIR/magistrala-coap &
