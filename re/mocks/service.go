...
// ListRuleExecutions provides a mock function for the type Service
func (_mock *Service) ListRuleExecutions(ctx context.Context, session authn.Session, pm re.RuleExecutionPageMeta) (re.RuleExecutionPage, error) {
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, authn.Session, re.RuleExecutionPageMeta) (re.RuleExecutionPage, error)); ok {
		return returnFunc(ctx, session, pm)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, authn.Session, re.RuleExecutionPageMeta) re.RuleExecutionPage); ok {
		r0 = returnFunc(ctx, session, pm)
	} else {
		r0 = ret.Get(0).(re.RuleExecutionPage)
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, authn.Session, re.RuleExecutionPageMeta) error); ok {
...
// Service_ListRuleExecutions_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ListRuleExecutions'
type Service_ListRuleExecutions_Call struct {
	*mock.Call
}

// ListRuleExecutions is a helper method to define mock.On call
//   - ctx context.Context
//   - session authn.Session
//   - pm re.RuleExecutionPageMeta
func (_e *Service_Expecter) ListRuleExecutions(ctx interface{}, session interface{}, pm interface{}) *Service_ListRuleExecutions_Call {
	return &Service_ListRuleExecutions_Call{Call: _e.mock.On("ListRuleExecutions", ctx, session, pm)}
}

func (_c *Service_ListRuleExecutions_Call) Run(run func(ctx context.Context, session authn.Session, pm re.RuleExecutionPageMeta)) *Service_ListRuleExecutions_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
		...
		var arg2 re.RuleExecutionPageMeta
		if args[2] != nil {
			arg2 = args[2].(re.RuleExecutionPageMeta)
		}
		run(
			arg0,
			arg1,
...
func (_c *Service_ListRuleExecutions_Call) Return(ruleExecutionPage re.RuleExecutionPage, err error) *Service_ListRuleExecutions_Call {
	_c.Call.Return(ruleExecutionPage, err)
	return _c
}

func (_c *Service_ListRuleExecutions_Call) RunAndReturn(run func(ctx context.Context, session authn.Session, pm re.RuleExecutionPageMeta) (re.RuleExecutionPage, error)) *Service_ListRuleExecutions_Call {
	_c.Call.Return(run)
	return _c
}
