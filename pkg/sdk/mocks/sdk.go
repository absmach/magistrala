...
func (_c *SDK_ListSubscriptions_Call) Run(run func(pm pkgsdk.PageMetadata, token string)) *SDK_ListSubscriptions_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(pkgsdk.PageMetadata), args[1].(string))
	})
	return _c
...
func (_c *SDK_ListSubscriptions_Call) Return(_a0 pkgsdk.SubscriptionPage, _a1 errors.SDKError) *SDK_ListSubscriptions_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *SDK_ListSubscriptions_Call) RunAndReturn(run func(pkgsdk.PageMetadata, string) (pkgsdk.SubscriptionPage, errors.SDKError)) *SDK_ListSubscriptions_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *SDK_ReadMessages_Call) Run(run func(pm pkgsdk.MessagePageMetadata, chanID string, domainID string, token string)) *SDK_ReadMessages_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(pkgsdk.MessagePageMetadata), args[1].(string), args[2].(string), args[3].(string))
	})
	return _c
}

func (_c *SDK_ReadMessages_Call) Return(_a0 pkgsdk.MessagesPage, _a1 errors.SDKError) *SDK_ReadMessages_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *SDK_ReadMessages_Call) RunAndReturn(run func(pkgsdk.MessagePageMetadata, string, string, string) (pkgsdk.MessagesPage, errors.SDKError)) *SDK_ReadMessages_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *SDK_ViewSubscription_Call) Return(_a0 pkgsdk.Subscription, _a1 errors.SDKError) *SDK_ViewSubscription_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *SDK_ViewSubscription_Call) RunAndReturn(run func(string, string) (pkgsdk.Subscription, errors.SDKError)) *SDK_ViewSubscription_Call {
	_c.Call.Return(run)
	return _c
}
