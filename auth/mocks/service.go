...
func (_m *Service) RetrieveDomainPermissions(ctx context.Context, token string, id string) (policy.Permissions, error) {
	ret := _m.Called(ctx, token, id)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) (policy.Permissions, error)); ok {
		return rf(ctx, token, id)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string) policy.Permissions); ok {
		r0 = rf(ctx, token, id)
	} else {
		if ret.Get(0) != nil {
