...
BUILD_DIR ?= build
SERVICES = auth users clients groups channels domains http coap notifications certs re postgres-writer postgres-reader timescale-writer timescale-reader cli alarms reports fluxmq
