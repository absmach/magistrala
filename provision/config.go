...
type ServiceConf struct {
	...
	ClientsURL  string `toml:"clients_url"   env:"SMQ_PROVISION_CLIENTS_URL"     envDefault:"http://localhost"`
	ChannelsURL string `toml:"channels_url"  env:"SMQ_PROVISION_CHANNELS_URL"    envDefault:"http://localhost"`
	UsersURL    string `toml:"users_url"     env:"SMQ_PROVISION_USERS_URL"       envDefault:"http://localhost"`
	CertsURL    string `toml:"certs_url"     env:"SMQ_PROVISION_CERTS_URL"       envDefault:"http://localhost"`
