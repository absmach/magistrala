...
// Package tracing provides tracing instrumentation for Mainflux things groups service.
//
// This package provides tracing middleware for Mainflux things groups service.
// It can be used to trace incoming requests and add tracing capabilities to
// Mainflux things groups service.
//
