...
func main() {
	...
	hs := httpserver.NewServer(ctx, cancel, svcName, httpServerConfig, httpapi.MakeHandler(repo, authn, clientsClient, channelsClient, policyEvaluator, policyService, atomClient, svcName, cfg.InstanceID), logger)
