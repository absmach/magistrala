...
func (x *ReadMessagesReq) GetWorkspaceId() string {
	if x != nil {
...
func (x *ListGatewayDevicesReq) GetWorkspaceId() string {
	if x != nil {
		return x.WorkspaceId
	}
	return ""
...
func (x *ListDeviceGatewaysReq) GetWorkspaceId() string {
	if x != nil {
		return x.WorkspaceId
	}
	return ""
...
const file_readers_v1_readers_proto_rawDesc = "" +
	...
	"\apayload\x18\x03 \x01(\fR\apayload\"\x92\x01\n" +
	...
	"\x05total\x18\x01 \x01(\x04R\x05total\x12=\n" +
	"\rpage_metadata\x18\x02 \x01(\v2\x18.readers.v1.PageMetadataR\fpageMetadata\x12,\n" +
	"\x05stats\x18\x03 \x03(\v2\x16.readers.v1.DeviceStatR\x05stats\"\xbb\x01\n" +
	"\x15ListGatewayDevicesReq\x12!\n" +
	"\fworkspace_id\x18\x01 \x01(\tR\vworkspaceId\x12\x1d\n" +
	"\n" +
	"channel_id\x18\x02 \x01(\tR\tchannelId\x12!\n" +
	"\fpublisher_id\x18\x03 \x01(\tR\vpublisherId\x12=\n" +
	"\rpage_metadata\x18\x04 \x01(\v2\x18.readers.v1.PageMetadataR\fpageMetadata\"\xb5\x01\n" +
	"\x15ListDeviceGatewaysReq\x12!\n" +
	"\fworkspace_id\x18\x01 \x01(\tR\vworkspaceId\x12\x1d\n" +
	"\n" +
