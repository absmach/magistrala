...
import (
	...
	oauth2 "github.com/absmach/magistrala/pkg/oauth2"
...
func (_m *Service) OAuthCallback(ctx context.Context, provider string, state oauth2.State, token xoauth2.Token, client clients.Client) (*magistrala.Token, error) {
	...
	var r0 *magistrala.Token
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, oauth2.State, xoauth2.Token, clients.Client) (*magistrala.Token, error)); ok {
		return rf(ctx, provider, state, token, client)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, oauth2.State, xoauth2.Token, clients.Client) *magistrala.Token); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, oauth2.State, xoauth2.Token, clients.Client) error); ok {
