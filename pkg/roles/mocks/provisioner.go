...
// RemoveMemberFromDomain provides a mock function for the type Provisioner
func (_mock *Provisioner) RemoveMemberFromDomain(ctx context.Context, domainID string, memberID string) error {
...
// Provisioner_RemoveMemberFromDomain_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'RemoveMemberFromDomain'
type Provisioner_RemoveMemberFromDomain_Call struct {
	*mock.Call
}
...
//   - domainID string
//   - memberID string
func (_e *Provisioner_Expecter) RemoveMemberFromDomain(ctx interface{}, domainID interface{}, memberID interface{}) *Provisioner_RemoveMemberFromDomain_Call {
	return &Provisioner_RemoveMemberFromDomain_Call{Call: _e.mock.On("RemoveMemberFromDomain", ctx, domainID, memberID)}
}

func (_c *Provisioner_RemoveMemberFromDomain_Call) Run(run func(ctx context.Context, domainID string, memberID string)) *Provisioner_RemoveMemberFromDomain_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *Provisioner_RemoveMemberFromDomain_Call) Return(err error) *Provisioner_RemoveMemberFromDomain_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *Provisioner_RemoveMemberFromDomain_Call) RunAndReturn(run func(ctx context.Context, domainID string, memberID string) error) *Provisioner_RemoveMemberFromDomain_Call {
	_c.Call.Return(run)
	return _c
}
