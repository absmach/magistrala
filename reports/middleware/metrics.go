...
func (mm *metricsMiddleware) ViewReportConfig(ctx context.Context, session authn.Session, id string) (reports.ReportConfig, error) {
	defer func(begin time.Time) {
	...
	return mm.service.ViewReportConfig(ctx, session, id)
}
