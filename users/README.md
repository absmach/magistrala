...
| MG_USERS_SECRET_KEY             | Default secret key used to generate tokens                              | mainflux                       |
...
| MG_USERS_DB_USER                | Database user                                                           | mainflux                       |
| MG_USERS_DB_PASS                | Database password                                                       | mainflux                       |
