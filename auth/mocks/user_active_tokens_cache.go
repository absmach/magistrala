...
func (_mock *UserActiveTokensCache) SaveActive(ctx context.Context, userID string, tokenID string, description string, ttl time.Duration) error {
...
//   - description string
//   - ttl time.Duration
func (_e *UserActiveTokensCache_Expecter) SaveActive(ctx interface{}, userID interface{}, tokenID interface{}, description interface{}, ttl interface{}) *UserActiveTokensCache_SaveActive_Call {
	return &UserActiveTokensCache_SaveActive_Call{Call: _e.mock.On("SaveActive", ctx, userID, tokenID, description, ttl)}
}

func (_c *UserActiveTokensCache_SaveActive_Call) Run(run func(ctx context.Context, userID string, tokenID string, description string, ttl time.Duration)) *UserActiveTokensCache_SaveActive_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *UserActiveTokensCache_SaveActive_Call) RunAndReturn(run func(ctx context.Context, userID string, tokenID string, description string, ttl time.Duration) error) *UserActiveTokensCache_SaveActive_Call {
	_c.Call.Return(run)
	return _c
}
