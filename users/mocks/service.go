...
// OAuthCallback provides a mock function with given fields: ctx, state, client
func (_m *Service) OAuthCallback(ctx context.Context, state oauth2.State, client clients.Client) (*magistrala.Token, error) {
	...
	var r0 *magistrala.Token
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, oauth2.State, clients.Client) (*magistrala.Token, error)); ok {
		return rf(ctx, state, client)
	}
	if rf, ok := ret.Get(0).(func(context.Context, oauth2.State, clients.Client) *magistrala.Token); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, oauth2.State, clients.Client) error); ok {
