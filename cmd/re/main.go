...
func main() {
	...
	svc, err := newService(database, msgSub, writersPub, alarmsPub, ec, logger, readersClient)
	if err != nil {
...
func newService(db pgclient.Database, rePubSub messaging.PubSub, writersPub, alarmsPub messaging.Publisher, ec email.Config, logger *slog.Logger, readersClient grpcReadersV1.ReadersServiceClient) (re.Service, error) {
