...
// Package main contains event-logs main function to start the event-logs service.
package main
...
import (
	...
	"github.com/absmach/magistrala/eventlogs/middleware"
	eventlogspg "github.com/absmach/magistrala/eventlogs/postgres"
...
const (
	svcName        = "event-logs"
	envPrefixDB    = "MG_EVENT_LOGS_"
	envPrefixHTTP  = "MG_EVENT_LOGS_HTTP_"
...
type config struct {
	LogLevel      string  `env:"MG_EVENT_LOGS_LOG_LEVEL"     envDefault:"info"`
	ESURL         string  `env:"MG_ES_URL"                   envDefault:"nats://localhost:4222"`
	JaegerURL     url.URL `env:"MG_JAEGER_URL"               envDefault:"http://jaeger:14268/api/traces"`
	SendTelemetry bool    `env:"MG_SEND_TELEMETRY"           envDefault:"true"`
	InstanceID    string  `env:"MG_EVENT_LOGS_INSTANCE_ID"   envDefault:""`
